...
/**
 * Class that listens to the user click on the game board and stores it for the
 * controller to retrieve. The listening parameter is used to check if the
 * listener should update the user click stored. Class that implements
 * {@link MouseListener}. Class that extends {@link GenericListener}.
 *
 */
