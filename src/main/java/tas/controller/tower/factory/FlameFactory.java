...
public interface FlameFactory {
	...
	static public Tower basicFlame(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilderImpl(pos, DefaultTowersUtils.JSONOBJECTMAP.get(DefaultTowers.BASICFLAME), enemyList)
	...
	static public Tower biFlame(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilderImpl(pos, DefaultTowersUtils.JSONOBJECTMAP.get(DefaultTowers.BIFLAME), enemyList)
	...
	static public Tower triFlame(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilderImpl(pos, DefaultTowersUtils.JSONOBJECTMAP.get(DefaultTowers.TRIFLAME), enemyList)
	...
	static public Tower quadFlame(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilderImpl(pos, DefaultTowersUtils.JSONOBJECTMAP.get(DefaultTowers.QUADFLAME), enemyList)
