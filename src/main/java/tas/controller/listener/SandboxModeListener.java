...
/**
 * Class that listens for the user clicks and stores their position for the
 * controller to retrieve them. Class that implements {@link MouseListener}.
 *
 */
public class SandboxModeListener extends GenericListener implements MouseListener {
	...
	/**
	 * Puts the Position the user has clicked on in lastNodeSelected. Adds
	 * lastNodeSelected to nosedSelected. Sets update to true.
	 */
	@Override
