...
public interface ArcherFactory {
	...
	static public Tower basicArcher(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilder(pos, DefaultTowersUtils.TOWERSJSONOBJECT.get(DefaultTowers.BASICARCHER), enemyList)
				.setUpgradable(true)
				.maxLevel(25)
	...
	static public Tower biArcher(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilder(pos, DefaultTowersUtils.TOWERSJSONOBJECT.get(DefaultTowers.BIARCHER), enemyList)
	...
	static public Tower triArcher(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilder(pos, DefaultTowersUtils.TOWERSJSONOBJECT.get(DefaultTowers.TRIARCHER), enemyList)
				.attackType(AttackType.MULTIPLE)
				.maximumTarget(3)
				.setUpgradable(true)
				.maxLevel(25)
	...
	static public Tower quadArcher(final Position pos, final List<Enemy> enemyList) {
		return new TowerBuilder(pos, DefaultTowersUtils.TOWERSJSONOBJECT.get(DefaultTowers.QUADARCHER), enemyList)
				.attackType(AttackType.MULTIPLE)
				.maximumTarget(4)
				.setUpgradable(true)
				.maxLevel(25)
