...
class ClassicTowerFactory {
	 ...
	 */
	protected ClassicTowerFactory(final int damage, final int range, final int delay, final int buildCost,
			final int startUpCost, final int maxLevel, final String imageName, final List<Enemy> enemyList) {
		this.damage = damage;
		this.range = range;
		this.delay = delay;
