...
public interface TeslaFactory {
	...
	static public Tower basicTesla(final Position pos, final List<Enemy> enemyList) {
		return new Builder(pos, 100, 9, 1100, "tesla", enemyList).attackType(AttackType.AREA).damageRange(7)
	...
	static public Tower superTesla(final Position pos, final List<Enemy> enemyList) {
		return new Builder(pos, 150, 9, 1100, "superTesla", enemyList).attackType(AttackType.AREA).damageRange(7)
	...
	static public Tower godTesla(final Position pos, final List<Enemy> enemyList) {
		return new Builder(pos, 200, 9, 1100, "godtesla", enemyList).attackType(AttackType.AREA).damageRange(7)
