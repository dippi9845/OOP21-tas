 ...
 * {@link TowerBuilderImpl#build()} for create that Tower
 */
public class TowerBuilderImpl implements TowerBuilder {
	 ...
	 */
	public TowerBuilderImpl(final Position pos, final int damage, final int radius, final int delay, final String towerName,
	 ...
	 * {@link TowerBuilderImpl#setEnemylist(List)} before the call to build method
	 * {@link TowerBuilderImpl#build()}
	 * 
	 * @param pos       Position of the Tower
	 * @param damage    Damage of the Tower
	 ...
	 * @param towerName Name of the tower
	 */
	public TowerBuilderImpl(final Position pos, final int damage, final int radius, final int delay,
	 ...
	 * {@link TowerBuilderImpl#TowerBuilder(Position, int, int, int, String)}) without
	 * the list of all visible enemy, that must be set, with the specific method
	 * {@link TowerBuilderImpl#setEnemylist(List)} before the call to
	 * {@link TowerBuilderImpl#build()} method
	 * 
	 * @param pos     position of the tower
	 * @param dataset a JSONObject with all the necessary fields
	 */
	public TowerBuilderImpl(final Position pos, final JSONObject dataset) {
	 ...
	 * {@link TowerBuilderImpl#TowerBuilder(Position, int, int, int, String)}) that
	 * without one of them the tower can't be instanced (except for enemy list, that
	 * must be added with the specific method, before the build call
	 * {@link TowerBuilderImpl#build()})
	 * 
	 ...
	 * @param enemyList List of all enemy in the map
	 */
	public TowerBuilderImpl(final Position pos, final JSONObject dataset, final List<Enemy> enemyList) {
		this(pos, dataset);
		this.visibleEnemy = Optional.ofNullable(enemyList);
	}
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl setEnemylist(final List<Enemy> enemyList) {
		this.visibleEnemy = Optional.ofNullable(enemyList);
		return this;
	}
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl attackType(final int attackType) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl setUpgradable(final boolean upgradable) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl cost(final int cost) {
		this.cost = cost;
		return this;
	}
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl maximumTarget(final int max) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl damageRange(final int range) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl findFirst(final Supplier<Optional<Enemy>> findFirstEnemy) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl upgradeDamage(final UnaryOperator<Integer> upgradeDamage) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl upgradeCost(final UnaryOperator<Integer> upgradeCost) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl startUpgradeCost(final int startUpgradeCost) {
	 ...
	 * @return this object
	 */
	public TowerBuilderImpl maxLevel(final int maxLevel) {
